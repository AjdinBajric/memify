<template>
  <div>
    ...
    >
      ...
      >
      <Divider type="horizontal" class="divider" />
      <a href="#" class="hamburger-link" @click.prevent="redirectToSavedTemplates"
        >Saved templates</a
      >
      <Divider type="horizontal" class="divider" />
      <a
      ...
      <a href="#"
        ...
        <Avatar
          alt="profile picture"
          style="background-color: purple; float: right"
        >
          <template #icon>
            <UserOutlined />
          </template>
...
export default {
  name: "App",
  components: { Drawer, UserOutlined, Divider, Avatar },
  setup() {
...
:root {
  --primary-color: #8976fd;
  --primary-color-2: #7562e0;
  --light-primary--color: #bfb4ff;
  --dark-color: #332c5c;
  --gray-color: #978fc9;
}
